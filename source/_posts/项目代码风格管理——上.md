...
![FIG](https://cdn.jsdelivr.net/gh/liluoao/cdn@0.0.3/image/php-fig.png)
...
![设置Code Style为PSR2](https://cdn.jsdelivr.net/gh/liluoao/cdn@0.0.3/image/phpstorm-psr2.png)_设置Code Style为PSR2_
...
![步骤1、2、3、4](https://cdn.jsdelivr.net/gh/liluoao/cdn@0.0.3/image/phpcs1.png)

注： 如果PHP文件过大过长，会出现超时的错误，需要修改 `timeout` 值，MAX 30（s）。提示数量也一样，最大 100。

![步骤5、6、7](https://cdn.jsdelivr.net/gh/liluoao/cdn@0.0.3/image/phpcs2.png)

注： IDE版本不同菜单会有所不同，直接搜索菜单名即可。

成功后代码里会出现对应的提示，默认是下图所示的下划线型的 `Warning` 警告

![phpcs格式警告](https://cdn.jsdelivr.net/gh/liluoao/cdn@0.0.3/image/phpcs3.png)
