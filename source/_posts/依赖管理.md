...
![GitHub项目开启服务](https://cdn.jsdelivr.net/gh/liluoao/cdn@0.0.4/image/composer-setting.png)

以上面例子项目发布成功后结果如下图所示

![成功示例](https://cdn.jsdelivr.net/gh/liluoao/cdn@0.0.4/image/packagist-final.png)
